...
class FeatureSelection:
    ...
    def preprocess(self, X, y, vectorizer):
    ...
    def acc2(self, X, y, vectorizer):

        self.preprocess(X, y, vectorizer)

        return np.abs(self.tpr - self.fpr)

    def ndm(self, X, y, vectorizer):
    ...
    def odds_ratio(self, X, y, vectorizer):
    ...
    def ChiSquare(self, X, y, vectorizer):
        self.preprocess(X, y, vectorizer)
